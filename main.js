...
$('#q').on('click',function(){
    ...
    setTimeout(function(){
        ...
        for(var i =0,size=arr.length;i<size;i+=4){
            var buf =[];  
        ...
        setTimeout(function(){
            for(var i=0;i<arr1.length;i+=4) {
                ...
                for(let j=0;j<4;j++){
                    ...
                    bufArr.push(arr1[i+j]);
                }
                mainА.write(bufArr,'wrire.txt'); 
            }
        ...
        for(let i =0;i<arr1.length;i+=4){
            ...
            buf=mainА.encryption(arr1[i],arr1[i+1],arr1[i+2],arr1[i+3]);
            for(let j=0;j<4;j++){

                decryptio.push(buf[j]);
            }


        }
        setTimeout(function(){
            for(var i=0;i<decryptio.length;i+=4) {
                var bufArr = [];
                for(let j=0;j<4;j++){

                    bufArr.push(decryptio[i+j]);
                }

                mainА.write(bufArr,'wrire1.txt'); 
            }
